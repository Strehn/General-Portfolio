...
{
  "$end", "error", "$undefined", "NAME", "NUMBER", "PI", "PHI", "PRINT",
  "'-'", "'+'", "'*'", "'/'", "UMINUS", "'\\n'", "'='", "'('", "')'",
  "$accept", "statement_list", "constant", "statement", "expression", YY_NULL
};
#endif
...
{
      17,    -9,   -10,   -10,   -10,   -10,    23,    23,     4,     0,
      26,    38,    23,   -10,   -10,   -10,    25,   -10,    27,    23,
     -10,    23,    23,    23,    23,    38,   -10,   -10,    38,    -8,
      -8,   -10,   -10
};
...
{
       0,    18,    17,     4,     5,     9,     0,     0,     0,    16,
       0,     8,     0,    18,    16,    14,     0,     1,     0,     0,
       2,     0,     0,     0,     0,     6,    15,     3,     7,    11,
      10,    12,    13
};
...
{
      15,    16,    23,    24,    17,    12,    25,     1,     2,     3,
       4,     5,     6,    28,    19,    29,    30,    31,    32,     7,
       1,     2,     3,     4,     5,     6,    13,     2,     3,     4,
      18,     6,     7,    21,    22,    23,    24,     9,     7,    20,
      27,    26,     0,     0,     0,     9,    21,    22,    23,    24
};

static const yytype_int8 yycheck[] =
{
       6,     7,    10,    11,     0,    14,    12,     3,     4,     5,
       6,     7,     8,    19,    14,    21,    22,    23,    24,    15,
       3,     4,     5,     6,     7,     8,     3,     4,     5,     6,
       8,     8,    15,     8,     9,    10,    11,     0,    15,    13,
      13,    16,    -1,    -1,    -1,     8,     8,     9,    10,    11
};
...
static const yytype_uint8 yystos[] =
{
      ...
      20,    21,    14,     3,    19,    21,    21,     0,    20,    14,
      13,     8,     9,    10,    11,    21,    16,    13,    21,    21,
      21,    21,    21
};
...
#line 37 "calc.y" /* yacc.c:1646  */
    {(yyvsp[0].symptr)->value = 3.14159; (yyval.dval) = 3.14159; }
#line 1222 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 38 "calc.y" /* yacc.c:1646  */
    {(yyvsp[0].symptr)->value = 1.61803; (yyval.dval) = 1.61803; }
